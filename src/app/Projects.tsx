    ...
    guenlog: {
      ...
      review: (
        <div>
          ...
          <br/>
          리코일의 경우 기존 수업에서 리덕스를 배웠기 때문에 다른 상태 관리 도구를 경험해 보자는 의견에 사용하게 되었으며
          기존의 리덕스보다 쉽고 간편하게 사용할 수 있다는 느낌을 받았습니다.
          <br/>
          하지만 반대로 많은 React 커뮤니티에서 널리 사용되고 구현되어 있으며 자료가 많은 리덕스를 조금 더 심도 있게 공부해 볼 필요성도 느끼게 되었습니다.
          <br/>
          엑시오스 라이브러리의 경우에는 학습에 들어가는 노력도 많이 필요하지 않고 요청과 응답 데이터를 자동으로 JSON 형식으로 변환해주어 간편하고 쉽게 사용할 수 있었습니다.
        </div>
      ),
    },
    animaltest: {

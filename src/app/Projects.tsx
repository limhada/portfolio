...
export default function Projects() {
  ...
  const guenlog = {
    ...
    reviw: (
      ...
      <div>
        ...
        데이터에 문제가 생기지 않도록 사전에 예방하였습니다.
        <br />
        OAuth2를 통해 구글로그인을 구현하는 과정에서 기존의 익숙한 Frontend에서
        Backend와 직접 통신하는 방식이 아닌 Frontend에서 GoogleServer를 거쳐
        Backend와 통신하는 것에 어려움이 있었습니다.
        <br />
        ...
        없을 시에는 null값을 출력합니다. URLSearchParams의 get메서드를 사용하여
        accesstoken 값과 처음 로그인하는 사용자인지 여부를 판별하는 데이터를
        가져올 수 있었고 문제를 해결할 수 있었습니다.
        <br />
  ...
  const animaltest = {
    background: (
      <div>
        이 심리테스트는 Big Five Personality Traits 라고도 알려진 성격 유형 분석
        기법을 사용하여 개발되었습니다. 이 기법은 각각의 다섯 가지 특성인 성격의
        측면에 따라 개인을 평가하는 방법입니다.
        <br />
        성실성, 외향성, 우호성, 신경성, 개방성과 같은 다섯가지 항목이 있습니다.
        <br />
        ...
        성격일 수 있습니다.
        <br />
        벌새: 계획적이고 체계적으로 일을 처리하는 성격으로, 부지런한 성격입니다.
        <br />
        ...
        <br />
        레서판다: 다른 사람들의 감정에 민감하게 반응하며 주변 사람들을 친절하게
        도와주는 경우가 많습니다.
        <br />
        악어: 다른 사람들의 감정에 어느 정도 반응하지만 자신의 의견을 단호하게
        표현하는 경우도 있습니다.
        <br />
        알파카: 다른 사람들의 감정에 둔감한 경우가 많으며 자신의 의견을 단호하게
        표현하는 경우가 많습니다.
        <br />
    ...
    reviw: (
      <div>
        ...
        특성(성실성, 외향성, 우호성, 신경성, 개방성)을 분석하여 개개인의 성격을
        평가하는 독특하고 흥미로운 방법이었습니다. 15개의 질문들을 통해 금방
        나만의 성격 유형을 찾아낼 수 있었고, 그 결과를 바탕으로 자기 성장과
        발전에 대한 귀중한 인사이트를 얻을 수 있었습니다.
        <br />
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      summary: '요약내용',
      background: animaltest.background,
      review: animaltest.reviw,
      stack: {
